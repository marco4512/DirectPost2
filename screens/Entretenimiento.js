...
const Entretenimiento=({navigation,route})=>{ 
  ...
  return (
    ...
    <NativeBaseProvider >
      ...
      <Divider my="2" />
      <Text color="white" fontSize="25"  style={styles.Titulos}>Cine</Text>
      <Divider my="2" />  
        <FlatList margin={0} horizontal refreshing data={Cine}
      ...
      <Divider my="2" />
      <Text color="white" fontSize="25"  style={styles.Titulos}>Farandula</Text>
      <Divider my="2" />  
        <FlatList margin={0} horizontal refreshing data={Farandula}
      ...
      <Divider my="2" />
      <Text color="white" fontSize="25"  style={styles.Titulos}>Literatura</Text>
      <Divider my="2" />  
        <FlatList margin={0} horizontal refreshing data={Literatura}
      ...
      <Divider my="2" />
      <Text color="white" fontSize="25"  style={styles.Titulos}>Comedia</Text>
      <Divider my="2" />  
        <FlatList margin={0} horizontal refreshing data={Comedia}
