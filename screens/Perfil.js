...
const Perfil=({navigation,route})=>{ 
  ...
  return (
    ...
    <NativeBaseProvider >
      ...
      <Text color="white" fontSize="30">{NombreUsuario}</Text>
      </Center >
      <HStack space={2} paddingTop={5} paddingBottom={5}  justifyContent="center">
      <Center >
      <Text color="white" fontSize="17">Nombre: Insertar NombreUsuario</Text>
      </Center>
      </HStack>
      <HStack space={2} paddingTop={5} paddingBottom={5}  justifyContent="center">
      <Center >
      <Text color="white" fontSize="17">Correo: Insertar Correo </Text>
      </Center>
      </HStack>
      <Divider my="2" />
      <Center>
